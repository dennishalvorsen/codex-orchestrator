...
```bash
bash <(curl -fsSL https://raw.githubusercontent.com/dennishalvorsen/codex-orchestrator/main/plugins/codex-orchestrator/scripts/install.sh)
```
...
The map is generated by [Cartographer](https://github.com/dennishalvorsen/cartographer), a companion Claude Code plugin:
